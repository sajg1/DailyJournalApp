...
//Handle Submission of Form
  ...
  render() {
    ...
    if (this.state.displayMessage) {
      display = <p className="no-display">--- No completed goals to display ---</p>
    } else {
      display =
        <div className="form-container">
          <div className="form-title">
            <h1>Daily Journal Entry</h1>
            <p className="intro-text">The aim of this type of journal entry is for it to allow you to focus your day as soon as you wake up giving you purpose and drive. Watch Tim Ferris explain how he uses the journal <a className="non-nav-link" href="https://www.youtube.com/watch?v=glFMpyx_oU4" target="_blank" rel="noreferrer">here</a>.</p>
          </div>
