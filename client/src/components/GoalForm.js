    ...
    return(
      <div>
        <div className="form-title">
          <h1>Goals</h1>
          <p className="intro-text">Before setting you're goals <a className="non-nav-link" href="https://www.mindtools.com/pages/article/newHTE_90.htm" target="_blank" rel="noreferrer">here</a> are the five golden rules of Goal Setting  in order to set yourself up for success.</p>
        </div>
